...
///* defined by Bosch
public enum SignalIdentifier: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [SignalIdentifier] = [
    .undefined,
    .iaq,
    .staticIaq,
    .co2Eq,
...
///* defined by Bosch
public enum SensorAccuracy: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case unreliable // = 0
  case lowAccuracy // = 1
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [SensorAccuracy] = [
    .unreliable,
    .lowAccuracy,
    .mediumAccuracy,
    .highAccuracy,
...
public enum MicSampleFreq: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [MicSampleFreq] = [
    .sampleRate8000,
    .sampleRate11025,
    .sampleRate16000,
    .sampleRate22500,
...
public enum MicGain: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case gain60Db // = 0
  case gain57Db // = 1
  case gain54Db // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [MicGain] = [
    .gain60Db,
    .gain57Db,
    .gain54Db,
    .gain51Db,
...
public enum MicBitResolution: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case bitRes8 // = 0
  case bitRes16 // = 1
  case bitRes24 // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [MicBitResolution] = [
    .bitRes8,
    .bitRes16,
    .bitRes24,
  ]
...
public enum CompressionType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [CompressionType] = [
    .opus,
    .flac,
  ]
...
public struct RadioPower: Sendable {
  ...
  public var snr: Int32 = 0

  public var rssiEst: Int32 = 0
...
public struct SimpleSensorReading: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct BuzzIntervalData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SDCardState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var totalSpace: UInt32 = 0
...
public struct MarkState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct MarkPacket: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SystemInfoPacket: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var buzzSummaryData: BuzzSummaryData {
    ...
    set {_uniqueStorage()._buzzSummaryData = newValue}
  }
  /// Returns true if `buzzSummaryData` has been explicitly set.
  public var hasBuzzSummaryData: Bool {return _storage._buzzSummaryData != nil}
...
public struct AudioCompression: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct LowPowerConfig: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CameraControl: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct DeviceUID: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct ConfigPacket: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct PeerAddress: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UWB_Range: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UWB_Info: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UWB_Packet: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SpecialFunction: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SystemSummaryPacket: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var classifierVersion: Float {
    get {return _storage._classifierVersion}
    set {_uniqueStorage()._classifierVersion = newValue}
  }
  ...
  public var batteryVoltage: Float {
    get {return _storage._batteryVoltage}
...
public struct LoRaPacket: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var payload: LoRaPacket.OneOf_Payload? = nil

  public var systemSummaryPacket: SystemSummaryPacket {
    get {
      if case .systemSummaryPacket(let v)? = payload {return v}
      return SystemSummaryPacket()
    }
    set {payload = .systemSummaryPacket(newValue)}
  }

  public var radioPower: RadioPower {
    get {return _radioPower ?? RadioPower()}
    set {_radioPower = newValue}
  }
  /// Returns true if `radioPower` has been explicitly set.
  public var hasRadioPower: Bool {return self._radioPower != nil}
  /// Clears the value of `radioPower`. Subsequent reads from it will return its default value.
  public mutating func clearRadioPower() {self._radioPower = nil}

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public enum OneOf_Payload: Equatable, Sendable {
    case systemSummaryPacket(SystemSummaryPacket)
  ...
  fileprivate var _header: PacketHeader? = nil
  fileprivate var _radioPower: RadioPower? = nil
}
...
extension RadioPower: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "RadioPower"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "rssi"),
    2: .same(proto: "snr"),
  ...
  public static func ==(lhs: RadioPower, rhs: RadioPower) -> Bool {
...
extension BuzzIntervalData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.lastDetectionEpoch != 0 {
      try visitor.visitSingularUInt32Field(value: self.lastDetectionEpoch, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension SDCardState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.totalSpace) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.totalSpace != 0 {
      try visitor.visitSingularUInt32Field(value: self.totalSpace, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension AudioConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.estimatedRecordTime.bitPattern != 0 {
...
extension Location: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularFloatField(value: &self.lon) }()
      case 3: try { try decoder.decodeSingularFloatField(value: &self.elev) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.elev.bitPattern != 0 {
      try visitor.visitSingularFloatField(value: self.elev, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension SystemSummaryPacket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "SystemSummaryPacket"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "classifier_version"),
    ...
    7: .standard(proto: "battery_voltage"),
    8: .same(proto: "temperature"),
    9: .same(proto: "humidity"),
    10: .same(proto: "gas"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 7: try { try decoder.decodeSingularFloatField(value: &_storage._batteryVoltage) }()
        case 8: try { try decoder.decodeSingularFloatField(value: &_storage._temperature) }()
        case 9: try { try decoder.decodeSingularFloatField(value: &_storage._humidity) }()
        case 10: try { try decoder.decodeSingularFloatField(value: &_storage._gas) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
      // https://github.com/apple/swift-protobuf/issues/1182
      if _storage._classifierVersion.bitPattern != 0 {
        try visitor.visitSingularFloatField(value: _storage._classifierVersion, fieldNumber: 1)
      }
      ...
      if _storage._batteryVoltage.bitPattern != 0 {
        try visitor.visitSingularFloatField(value: _storage._batteryVoltage, fieldNumber: 7)
      }
      if _storage._temperature.bitPattern != 0 {
        try visitor.visitSingularFloatField(value: _storage._temperature, fieldNumber: 8)
      }
      if _storage._humidity.bitPattern != 0 {
        try visitor.visitSingularFloatField(value: _storage._humidity, fieldNumber: 9)
      }
      try { if let v = _storage._gas {
  ...
  public static func ==(lhs: SystemSummaryPacket, rhs: SystemSummaryPacket) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension LoRaPacket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "LoRaPacket"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "header"),
    2: .standard(proto: "system_summary_packet"),
    3: .same(proto: "radioPower"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularMessageField(value: &self._header) }()
      case 2: try {
        var v: SystemSummaryPacket?
        var hadOneofValue = false
        if let current = self.payload {
          hadOneofValue = true
          if case .systemSummaryPacket(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.payload = .systemSummaryPacket(v)
        }
      }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._radioPower) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if case .systemSummaryPacket(let v)? = self.payload {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._radioPower {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: LoRaPacket, rhs: LoRaPacket) -> Bool {
    if lhs._header != rhs._header {return false}
    if lhs.payload != rhs.payload {return false}
    if lhs._radioPower != rhs._radioPower {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
